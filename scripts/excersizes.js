 ...
 */
const Excersizes = ["Seated Leg Press - Legs", "Hip Adduction - Legs", "Hip Abduction - Legs", "Glute - Legs", "Leg Curl - Legs", "Calf Extension - Legs", "Seated Leg Curl - Legs", "Leg Extension - Legs",
										 ...
										 "Seated One Arm Shoulder - Shoulders", "Seated Two Arm Shoulder Press Off Back Pad - Shoulders", "Standing One Arm Shoulder Press - Shoulders", "Seated Chest Press - Chest", "Seated Incline-Decline Combination Press - Chest", "Seated Fly - Arms", "Seated One Arm Press Off Back Pad - Arms", "Standing One Arm Press With Rotation - Arms",
										 ...
										 "Dumbbell Bicep Curl - Arms", "Dumbbell Behind Head - Arms", "Dumbbells Lift - Arms", "Sit Ups - Core", "Curl Ups - Core", "Treadmill - Cardio", "Stair Climber - Cardio", "Ladder Climb - Cardio", "Stationary Bike - Cardio"];
Excersizes.sort();
export default Excersizes;

export const WEIGHT_DISABLED_EXCERSIZES = ["Plank - Core", "Sit Ups - Core", "Curl Ups - Core", "Push Ups - Arms", "Pull Ups - Arms", "Core Ball - Core"];